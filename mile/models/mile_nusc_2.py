...
from mile.models.gen_networks_one import WorldGen
...
class Mile_UINT(nn.Module):
    ...
    def forward_gen(self, batch):
        ...
        losses_gen['loss_gen_adv_b'] = self.cfg.DIS.GAN_WEIGHT * self.dis_b.calc_gen_loss(x_b_recon['rgb_label_1']) #0.1 1
