...
#############
_C.IMAGE = CN()
_C.IMAGE.SIZE = (600,960) #(450, 800)
_C.IMAGE.CROP = [32, 130, 800, 450]#[16, 130, 784, 450]  # (left, top, right, bottom) [0, 150, 800, 450]
_C.IMAGE.FOV = 100
...
_C.NUSC.IMAGE_FINAL_DIM = (320, 768) # 最终的尺寸，和carla的对齐
_C.NUSC.IMAGE_RESIZE_SCALE = 0.5
_C.NUSC.IMAGE_CROP = [16, 130, 784, 450]  # (left, top, right, bottom) [0, 150, 800, 450]
