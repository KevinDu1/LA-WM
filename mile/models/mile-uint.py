...
class Mile_UINT(nn.Module):
    ...
    def forward_gen(self, batch):
        ...
        #decode bev
        # bev_a = self.gen_a.decoder_bev(batch_a, h_a + noise_a) 
        ...
        losses_gen['kl_as_recon'] = 0.01 * self.__compute_kl(h_a_recon) #0.01
        #bev loss
        # losses_gen.update(self.cal_bev_loss(bev_a, batch_a, 'bev_carla')) #0.05
