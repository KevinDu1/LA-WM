...
class CombineDataModule(Dataset):
    def __init__(self, cfg):
        ...
        self.batch_size = self.cfg.BATCHSIZE
        self.sequence_length = self.cfg.RECEPTIVE_FIELD + self.cfg.FUTURE_HORIZON
        self.nusc = NuScenes(version='v1.0-trainval', dataroot='/data/dujiatong/nusc', verbose=True) #v1.0-trainval
    ...
    def __len__(self):
        ...
        self.total_len = len(self.train_nusc)
