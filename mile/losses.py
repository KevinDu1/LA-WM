...
from mile.utils.network_utils import pack_sequence_dim
...
class KLLoss(nn.Module):
    ...
    def forward(self, prior_mu, prior_sigma, posterior_mu, posterior_sigma):
        ...
        prior_mu = pack_sequence_dim(prior_mu)
        prior_sigma = pack_sequence_dim(prior_sigma)
        posterior_mu = pack_sequence_dim(posterior_mu)
        posterior_sigma = pack_sequence_dim(posterior_sigma)
