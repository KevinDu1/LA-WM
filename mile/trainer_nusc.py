...
from mile.models.mile_nusc import Mile_UINT
...
class GANTrainer(pl.LightningModule):
    def __init__(self, hparams, path_to_conf_file=None, pretrained_path=None):
        ...
        if pretrained_path:
            self.cfg.PRETRAINED.RESUME = pretrained_path
        # print(self.cfg)
    ...
    def load_pretrained_weights_val(self):
        if self.cfg.PRETRAINED.RESUME:
            ...
            if os.path.isfile(self.cfg.PRETRAINED.PATH):
                ...
                raise FileExistsError(self.cfg.PRETRAINED.RESUME)
        else:
            print('do not need to reload')

    def training_step(self, batch, batch_idx, optimizer_idx):
        batch = self.preprocess(batch, 'real')
    ...
    def configure_optimizers(self):
        ...
        dis_params = list(self.model.dis_b.parameters())
        gen_params = list(self.model.gen_b.parameters())
