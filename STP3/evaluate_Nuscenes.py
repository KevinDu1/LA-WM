...
class Eval():
    def __init__(self):
        ...
        self.intrinsics = self.get_intrinsic_matrix(self.fov, 450, 800)
    ...
    def evaluate(self, checkpoint_path=None, dataroot=None):
        ...
        agent = CilrsAgent('/home/balink/carla-roach-unit/outputs/2024-04-25/16-41-23/config_agent.yaml')
        ...
        for index, batch in enumerate(tqdm(valloader)):
            ...
            outputs_sim = policy.forward_sim(img, state)
    ...
    def run(self):
        self.evaluate(checkpoint_path='ckpt/STP3_plan.ckpt', dataroot='/home/balink/nuscenes-devkit/data/sets/nuscenes')
