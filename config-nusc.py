...
#############
_C.IMAGE = CN()
_C.IMAGE.SIZE = (491, 816) #(450, 800)
_C.IMAGE.CROP = [8,107,808,491] #[8,41,808,491] #[0, 66, 800, 450]#[16, 130, 784, 450]  # (left, top, right, bottom) [0, 150, 800, 450]
_C.IMAGE.FOV = 65.6 #100
_C.IMAGE.CAMERA_POSITION = [1.7, 0.0, 1.5] #[0.5, 0.0, 2.0]  # (forward, right, up)
