...
_C.VAL_CHECK_INTERVAL = 500
_C.LOGGING_INTERVAL = 100
_C.LIMIT_VAL_BATCHES = 1

_C.RECEPTIVE_FIELD = 6
_C.FUTURE_HORIZON = 6
...
#############
_C.IMAGE = CN()
_C.IMAGE.SIZE = (540,960)#(491, 816) #(450, 800)
_C.IMAGE.CROP = [0,28,960,540]#[8,107,808,491] #[8,41,808,491] #[0, 66, 800, 450]#[16, 130, 784, 450]  # (left, top, right, bottom) [0, 150, 800, 450]
_C.IMAGE.FOV = 61.2 #100
_C.IMAGE.CAMERA_POSITION = [1.5, 0.0, 1.5] #[0.5, 0.0, 2.0]  # (forward, right, up)
...
_C.MODEL.TRANSITION.STATE_DIM = 1024  # Dimension of prior/posterior
...
_C.LOSSES.WEIGHT_SEGMENTATION = 0.05
_C.LOSSES.WEIGHT_INSTANCE = 0.05
_C.LOSSES.WEIGHT_PROBABILISTIC = 0.01 #1e-3
_C.LOSSES.KL_BALANCING_ALPHA = 0.75

_C.PRETRAINED = CN()
_C.PRETRAINED.PATH = ''
_C.PRETRAINED.RESUME = True

# There parameters are only used to benchmark other models.
_C.EVAL = CN()
_C.EVAL.RGB_SUPERVISION = True
...
##################### Nuscenes
_C.NUSC = CN()
_C.NUSC.IMAGE_NAMES = ['CAM_FRONT']
_C.NUSC.IMAGE_ORIGINAL_HEIGHT = 900  # Original input RGB camera height
_C.NUSC.IMAGE_ORIGINAL_WIDTH = 1600  # Original input RGB camera width
_C.NUSC.IMAGE_FINAL_DIM = (384, 800) # 最终的尺寸，和carla的对齐(384, 800)
_C.NUSC.IMAGE_RESIZE_SCALE = 0.5
_C.NUSC.IMAGE_CROP = [0, 66, 800, 450]  # (left, top, right, bottom) [0, 150, 800, 450][0, 66, 800, 450]
_C.NUSC.LIFT_GT_DEPTH = False

##################### Discriminator
_C.DIS = CN()
_C.DIS.N_LAYER = 4
_C.DIS.GAN_TYPE = 'lsgan'
_C.DIS.GAN_WEIGHT = 1
